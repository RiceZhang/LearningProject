package com.zrx.common.dto;

import com.zrx.common.exceptions.StatusCode;
...
public class ApiResult<T> implements Serializable {
     ...
     */
    public static <T> ApiResult<T> newFailure(StatusCode code, String message){
        ApiResult<T> result = new ApiResult<>();
        result.setCode(code.getCode()!=0 ? code.getCode() : -1);
