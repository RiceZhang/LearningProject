...
/**
 * Function:    BaseJediesDemo  --------- redies 的 curd 操作
 * Author:      zhangrixiong
 * DateTime:    2016/9/2 13:20
 *
 * @see https://github.com/alvinto/spring-redis/blob/master/src/main/java/com/ws/redis/RedisClient.java
 * 1： 先开启 redis 服务
 * 2： 执行java . main 操作
 */
...
//        shardedJedisPool.returnResource(shardedJedis);
    ...
    private void KeyOperate() {
        ...
        //查看某个key的剩余生存时间，单位秒，永久生存或不存在都返回-1
        System.out.println("查看key001的剩余生存时间："+jedis.ttl("key001"));
        System.out.println("移除key001的生存时间："+jedis.persist("key001"));
        System.out.println("查看key001的剩余生存时间："+jedis.ttl("key001"));
        //查看key所存储的数据的类型
        System.out.println("查看key001存储的值的类型："+jedis.type("key001"));
